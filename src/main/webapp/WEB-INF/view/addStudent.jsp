...
<body>
	...
	<form:form method="post" action="${contextPath}/student/process" commandName="student">
	    First Name:<form:input path="firstName" value="${student.firstName}" required="true"/><br/>
	    Last Name:<form:input path="lastName" value="${student.lastName}" required="true"/><br/>
